...
def forum_search():
        ...
        list_vet = veterans.get_all_veterans()
        veteran = ""
        for v in list_vet:
                if v.email == email:
                        veteran = v
...
def top_three():
        ...
        user = ""
        for v in list_vet:
                if str(v.email).lower() == str(email).lower():
                        user = v
        ...
        for veteran in o_veterans:
                ...
                print(points)
                score = (points / 5) * 100
                if str(veteran.email).lower() != str(user.email).lower():
                        print(score)
                        if 'theserviceconnection.com' in str(veteran.email).lower():
